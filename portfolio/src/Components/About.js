  ...
  return (
    <div className="h-full p-10 shadow-lg" id="About">
      <div className="flex items-center justify-center  flex-col w-full mt-20 space-y-5">
        <p className="font-semibold md:text-5xl text-3xl md:mb-5">ABOUT ME</p>
        <span className="bg-sky-500 w-20 h-2 rounded-2xl"></span>

        <p className="font-light text-center md:text-2xl text-xl md:mx-36 md:mb-28">
        ...
        <div className="flex flex-col lg:flex-row min-w-min">
          <div data-aos="zoom-in" className="md:w-3/5 my-20 mx-20 ">
            <p className="font-semibold md:text-3xl text-3xl md:mb-10 mb-5">
              Get To know me!
            </p>
            <p className="font-light text-xl leading-10">
              I'm a student majoring in Software Engineering at SUST with a
              passion for web development. As a full stack developer, my goal is
              to design more engaging and user-friendly websites in order to
          ...
          <div data-aos="zoom-in" className="md:w-2/5 w-full mx-10  my-20">
            <p className="font-semibold ml-10 md:mb-10 mb-5 md:text-3xl text-2xl">
              My Skills
            </p>
            ...
            <div className="flex flex-col">
              <div className="flex flex-row">
                <div className="w-28 py-2 rounded-2xl text-center my-5 ml-9 bg-gray-300  hover:bg-blue-400 hover:scale-110 duration-500">
                  <p className="font-light text-base hover:text-white">REACT</p>
                </div>
                ...
                <div className="w-20  py-2 rounded-2xl text-center my-5 mx-2 bg-gray-300  hover:bg-blue-400 hover:scale-110 duration-500">
                  <p className="font-light text-base hover:text-white ">CSS</p>
                </div>
                <div className="w-20 py-2 rounded-2xl text-center my-5 mx-2 bg-gray-300  hover:bg-blue-400 hover:scale-110 duration-500">
                  <p className="font-light text-base hover:text-white">HTML</p>
                </div>
              </div>
              ...
              <div className="flex flex-row">
                ...
                <div className="w-24 py-2 rounded-2xl text-center my-5 mx-2 bg-gray-300 hover:bg-blue-400 hover:scale-110 duration-500">
                  <p className="font-light text-base hover:text-white">MYSQL</p>
                </div>
              ...
              <div className="flex flex-row">
                ...
                <div className="w-44 py-2 rounded-2xl text-center my-5 ml-2 lg:ml-3 bg-gray-300 hover:bg-blue-400 hover:scale-110 duration-500">
                  <p className="font-light text-base hover:text-white">
                    RESPONSIVE DESIGN
                  </p>
                </div>
